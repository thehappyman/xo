...
const Board = () => {
    const {squares, xnext, ties, winnerLine, handleReset, winner, activeUser} = useContext(GameContext);
    return (
        <div className='board'>
            ...
            <div className='board__footer'>
                <div className='card bg-blue'>
                    <p className='text-light'>{activeUser} (you)</p>
                ...
                <div className='card bg-yellow'>
                    <p className='text-light'>{activeUser === 'x' ? 'o' : 'x'} (cpu)</p>
                    <strong className='text-2xl'>{activeUser === 'x' ? ties.o : ties.x}</strong>
                </div>
            </div>
        </div>
    );
